...
import { cancelarMovimiento, type ActionState } from "@/lib/actions/inventory";

const initialState: ActionState = { error: null };

export function CancelMovementButton({ movementId }: { movementId: string }) {
  const [state, formAction, pending] = useActionState(cancelarMovimiento, initialState);
